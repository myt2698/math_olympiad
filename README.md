...
- 首次选择孩子名字、年级和开始日期
- 年级创建后保持不变，第一天日期可从主页右上角调整
- 一年级与二年级连续 80 天学习计划：每个年级 40 天，每天安排 2–3 个短视频和对应随堂题
- 按学后第 1、3、7、14 天自动安排轻量复习
- 60 道亲子拆题训练按每天 2 道分布到前 30 天
- 完成视频后才解锁当日挑战
- 顶部 80 天日期地图，可自由查看每天的学习内容
- 浏览器本地保存学习进度，刷新不丢失
- 桌面端及手机端自适应

## 接入真实视频和题库

一年级和二年级已接入正式视频清单及逐视频随堂题；其他年级仍使用 `app.js` 中的演示数据。继续接入内容时，建议把课程整理成 JSON：
